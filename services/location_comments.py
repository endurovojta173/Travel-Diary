...
from repositories.location_comments import remove_comment_from_location as repo_remove_my_comment_from_location
...
class LocationCommentsService:
    ...
    def remove_comment_from_location(self, id_comment: int) -> Optional[int]:
        return repo_remove_my_comment_from_location(self.conn, id_comment)
