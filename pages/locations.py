...
async def add_comment(location_id: int, request: Request,
                      svc: LocationCommentsService = Depends(location_comments_service), comment_text: str = Form(...)):
...
async def remove_comment(location_id: int, svc: LocationCommentsService = Depends(location_comments_service),
                         comment_id: int = Form(...)):
